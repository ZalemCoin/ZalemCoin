...
Section -post SEC0001
    ...
    #    WriteRegStr HKCR "bitcoin" "" "URL:ZalemCoin"
    #    WriteRegStr HKCR "bitcoin\DefaultIcon" "" $INSTDIR\bitcoin-qt.exe
    #    WriteRegStr HKCR "bitcoin\Zalem-Coin\open\command" "" '"$INSTDIR\bitcoin-qt.exe" "$$1"'
SectionEnd
...
Section -un.post UNSEC0001
    ...
    #Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\ZalemCoin.lnk"
    #Delete /REBOOTOK "$SMSTARTUP\ZalemCoin.lnk"
