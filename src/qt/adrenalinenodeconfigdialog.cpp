...
{
    ui->setupUi(this);
    QString desc = "rpcallowip=127.0.0.1<br>rpcuser=REPLACEME<br>rpcpassword=REPLACEME<br>server=1<br>listen=1<br>port=REPLACEMEWITHYOURPORT<br>floatingcity=1<br>floatingcityaddr=" + nodeAddress + "<br>floatingcityprivkey=" + privkey + "<br>";
