...
/** ZalemCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ZalemCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ZalemCoinUnits(QObject *parent);
...
typedef ZalemCoinUnits::Unit ZalemCoinUnit;
