...
/**
 * Split Zalem-Coin command line into a list of arguments. Aims to emulate \c bash and friends.
 *
...
void RPCConsole::setClientModel(ClientModel *model)
{
    ...
    if (model && clientModel->getPeerTableModel() && clientModel->getBanTableModel())
    {
        ...
        setFloatingcityCount(model->getFloatingcityCountString());
        connect(model, SIGNAL(strFloatingcitiesChanged(QString)), this, SLOT(setFloatingcityCount(QString)));
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Zalem-Coin RPC console.") + "<br>" +
...
void RPCConsole::setFloatingcityCount(const QString &strFloatingcities)
{
    ui->floatingcityCount->setText(strFloatingcities);
}
