...
extern bool fFloatingCity;
extern bool fLiteMode;
extern bool fEnableInstantX;
extern int nInstantXDepth;
extern int nMNengineRounds;
extern int nAnonymizeZalemCoinAmount;
extern int nLiquidityProvider;
extern bool fEnableMNengine;
extern int64_t enforceFloatingcityPaymentsTime;
extern std::string strFloatingCityAddr;
extern int nFloatingcityMinProtocol;
...
{
    std::string s = strprintf("Zalem-Coin-%s", name);
