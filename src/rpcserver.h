...
/**
 * ZalemCoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern json_spirit::Value floatingcity(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value floatingcitylist(const json_spirit::Array& params, bool fHelp);
