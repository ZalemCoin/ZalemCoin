...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "Stop Zalem-Coin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Zalem-Coin server stopping";
}
...
/* Floatingcity features */
    { "spork",                  &spork,                  true,      false,      false },
    { "floatingcity",             &floatingcity,             true,      false,      true },
    { "floatingcitylist",         &floatingcitylist,         true,      false,      false },
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        string strWhatAmI = "To use Zalem-Coind";
...
std::string HelpExampleCli(string methodname, string args){
    return "> Zalem-Coind " + methodname + " " + args + "\n";
}
